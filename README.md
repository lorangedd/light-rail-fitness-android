...
<!-- 修改时间：2026-09-08 18:35:00 +08:00；目的：更新 v1.0.12 发布、校验与同步后的 GitHub HTTPS 版本检查说明。 -->
...
当前版本为 `1.0.12`（versionCode `13`）：

- 包名：`cn.lightrail.fitnessokr`
- SHA-256：`9BBE945550B199B87F0A17DFD32CD0680B08CB1AAF030886672D5E89E1FFB2DC`
