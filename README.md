...
<!-- 修改时间：2026-09-08 11:10:00 +08:00；目的：更新 v1.0.6 发布、校验与受限 GitHub HTTPS 版本检查说明。 -->
...
当前版本为 `1.0.6`（versionCode `7`）：

- 包名：`cn.lightrail.fitnessokr`
- SHA-256：`048EA56DFB1404632322FC984E3D964143F74FF4754B6F41636A87A8C39BD82A`
