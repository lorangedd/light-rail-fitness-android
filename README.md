...
<!-- 修改时间：2026-09-08 17:55:00 +08:00；目的：更新 v1.0.11 发布、校验与同步后的 GitHub HTTPS 版本检查说明。 -->
...
当前版本为 `1.0.11`（versionCode `12`）：

- 包名：`cn.lightrail.fitnessokr`
- SHA-256：`1219B5614809D02E9AB25D91AD054978896EF75E042431B50AE594FFD86B18DA`
