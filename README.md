...
<!-- 修改时间：2026-09-08 16:55:00 +08:00；目的：更新 v1.0.9 发布、校验与同步后的 GitHub HTTPS 版本检查说明。 -->
...
当前版本为 `1.0.9`（versionCode `10`）：

- 包名：`cn.lightrail.fitnessokr`
- SHA-256：`F53DC8163EF8808B997BF147F7E8DF89D6243ED0958AAB06D042CAEB88D90DE2`
